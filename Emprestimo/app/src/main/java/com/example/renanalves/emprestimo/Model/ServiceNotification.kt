...
import com.example.renanalves.emprestimo.R
import com.example.renanalves.emprestimo.ResultNotificationActivity
import java.util.*

class ServiceNotification: IntentService("NotificationService") {
    ...
    private fun createChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.description = "Hora de pegar o seu item de volta."
